...
public class RabbitAdminTest {
    ...
    public void testRabbitAdmin() {
        // 创建Direct模式Exchange
        rabbitAdmin.declareExchange(new DirectExchange("test_spring_direct_exchange", false, false));
        // 创建Topic模式Exchange
        ...
        rabbitAdmin.declareBinding(new Binding("test_spring_direct_queue",
                Binding.DestinationType.QUEUE,
                "test_spring_direct_exchange", "direct", new HashMap<>()));
